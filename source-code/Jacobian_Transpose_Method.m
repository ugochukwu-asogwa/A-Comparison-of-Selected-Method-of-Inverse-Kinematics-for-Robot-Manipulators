%This function performs the Jacobian Transpose method of solving the
%inverse kinematics problem
%function [] = Jacobian_Transpose_Method()
clc;

disp('Jacobian Transpose Method selected');
syms q1 q2 q3 q4 q5
...
switch dof
    case 2
        ...
        for i = 1:inf
            ...
            q(:,i+1) = q(:,i) + xi*Jt_*(xf - kinematics_);
            toc
        ...
        title('Jacobian Transpose 2-DOF')
    ...
    case 3
        ...
        xlabel('Number of Iterations')
        ylabel('x^{ith} Position')
        title('Jacobian Transpose 3-DOF')
        plots(iterations,x_position,y_position,distance,alpha_deg,alpha_rad,alpha_grad,x_,y_)
    ...
    case 4
        ...
        xlabel('Number of Iterations')
        ylabel('x^{ith} Position')
        title('Jacobian Transpose 4-DOF')
        plots(iterations,x_position,y_position,distance,alpha_deg,alpha_rad,alpha_grad,x_,y_)
    ...
    case 5
        ...
        xlabel('Number of Iterations')
        ylabel('x^{ith} Position')
        title('Jacobian Transpose 5-DOF')
        plots(iterations,x_position,y_position,distance,alpha_deg,alpha_rad,alpha_grad,x_,y_)
